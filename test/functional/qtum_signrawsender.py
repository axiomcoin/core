...
class NirvanaSignRawSenderTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Now send some nirvana to both addresses (one contract will increase its balance and the other one will throw),
