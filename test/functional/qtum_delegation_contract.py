...
class NirvanaSimpleDelegationContractTest(BitcoinTestFramework):
    ...
    """
        - Check that it is not possible to use an input with less value than 100 nirvana as the first input to the coinstake.
        - Check that 100 nirvana is just enough for the first input to the coinstake.
    """
    def nas_staker_must_be_100_nirvana_test(self):
    ...
    def run_test(self):
        ...
        print("nas_staker_must_be_100_nirvana_test")
        self.nas_staker_must_be_100_nirvana_test()
        self.sync_all()
...
if __name__ == '__main__':
    NirvanaSimpleDelegationContractTest().main()
