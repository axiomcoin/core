...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // nirvana
        hashUTXORoot.SetNull(); // nirvana
    ...
    virtual bool IsProofOfStake() const //nirvana
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //nirvana
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //nirvana
    {
