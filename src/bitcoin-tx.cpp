...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " nirvana-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  nirvana-tx [options] <hex-tx> [commands]  Update hex-encoded nirvana transaction\n" +
            "or:     nirvana-tx [options] -create [commands]   Create hex-encoded nirvana transaction\n" +
            "\n";
