#ifndef NIRVANAVERSIONCHECKER_H
#define NIRVANAVERSIONCHECKER_H

#include <QObject>

#define NIRVANA_RELEASES "https://github.com/nirvana-fnd/nirvana/releases"
...
class NirvanaVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit NirvanaVersionChecker(QObject *parent = 0);
    ~NirvanaVersionChecker();
