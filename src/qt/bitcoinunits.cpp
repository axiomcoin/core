...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("NIRVANA");
    case mBTC: return QString("mNIRVANA");
    case uBTC: return QString::fromUtf8("μNIRVANA (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Nirvanas");
    case mBTC: return QString("Milli-Nirvanas (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Nirvanas (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
