...
//    initState();
    ...
    std::vector<NirvanaTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createNirvanaTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createNirvanaTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createNirvanaTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createNirvanaTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
